                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('barang.update', $barang->id) }}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input id="nama_barang" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="text" name="nama_barang" value="{{ old('nama_barang', $barang->nama_barang) }}" required autofocus />
                        </div>

                        <div class="mt-4">
                            <label for="kategori_id" class="block font-medium text-sm text-gray-700">Kategori</label>
                            <select name="kategori_id" id="kategori_id" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" required>
                                <option value="">Pilih Kategori</option>
                                @foreach ($kategoris as $kategori)
                                    <option value="{{ $kategori->id }}" @selected(old('kategori_id', $barang->kategori_id) == $kategori->id)>
                        ...
                        <div class="mt-4">
                            ...
                            <input id="stok" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="number" name="stok" value="{{ old('stok', $barang->stok) }}" required />
                        </div>

                        <div class="mt-4">
                            <label for="harga" class="block font-medium text-sm text-gray-700">Harga</label>
                            <input id="harga" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="number" name="harga" value="{{ old('harga', $barang->harga) }}" required />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            @if($barang->gambar)
                                <div class="mb-4">
                                    ...
                                    <img src="{{ asset('storage/' . $barang->gambar) }}" alt="Gambar Barang" class="w-32 h-32 object-cover rounded-md border">
                                </div>
                            @endif
                            <div id="drop-area" class="mt-1 border-2 border-dashed border-gray-300 rounded-md p-6 text-center cursor-pointer hover:border-indigo-500 transition-colors">
                                <div id="drop-content">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600">Drag and drop gambar baru di sini, atau <span class="text-indigo-600 hover:text-indigo-500">klik untuk memilih</span></p>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload gambar baru jika ingin mengganti (opsional, max 2MB, format: jpeg, png, jpg, gif)</p>
                        </div>

                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('barang.index') }}" class="px-4 py-2 bg-gray-200 rounded-md text-sm font-semibold text-gray-800">Batal</a>
