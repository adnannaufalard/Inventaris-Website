        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <a href="{{ route('kategori.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 mb-4">
                        Tambah Kategori
                    </a>
                        ...
                        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @forelse ($kategoris as $kategori)
                                    <tr>
                                        <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">{{ $kategori->nama_kategori }}</td>
                                        <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $kategori->deskripsi }}</td>
                                        <td class="whitespace-nowrap px-4 py-2">
                                            <div class="flex gap-2">
                                                <a href="{{ route('kategori.edit', $kategori->id) }}" class="inline-block rounded bg-indigo-600 px-4 py-2 text-xs font-medium text-white hover:bg-indigo-700">Edit</a>
